...
function frontend_taskpress_scripts() {
    wp_enqueue_style('taskpress-fullcalender', TASKPRESS_ADMIN_ASSETS . 'css/fullcalender.min.css', array(), TASKPRESS_PLUGIN_VERSION);
    wp_enqueue_script('taskpress-fullcalender', TASKPRESS_ADMIN_ASSETS . 'js/fullcalender.min.js', array('jquery'), TASKPRESS_PLUGIN_VERSION);
    wp_enqueue_style('taskpress-public', TASKPRESS_FRONT_ASSETS . 'taskpress-public.css', array(), TASKPRESS_PLUGIN_VERSION);
}
add_action('wp_enqueue_scripts', 'frontend_taskpress_scripts');